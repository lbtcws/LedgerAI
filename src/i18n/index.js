...
const messages = {
  zh: {
    ...
    stats: {
      ...
      aiError: '⚠️ 分析失败',
      aiNotConfiguredTitle: 'AI 未配置',
      aiNotConfiguredMsg: 'AI 账单分析需要先配置 API Key，是否立即前往设置？',
      aiConfirmGoSettings: '去设置',
      aiCancel: '取消',
      aiInvalidKeyTitle: 'API Key 无效',
      aiInvalidKeyMsgDialog: '您的 API Key 似乎无效，是否立即前往设置更新？',
      aiRequestTimeout: '请求超时',
      aiAnalysisFailed: '分析失败',
      aiAnalysisFailedDetail: '分析失败：',
    ...
    settings: {
      ...
      themeLight: '浅色',
      customBg: '自定义背景色',
      customBgDesc: '使用自定义颜色作为背景',
      customBgEnabled: '已启用自定义背景',
      customBgDisabled: '已禁用自定义背景',
      ...
      english: 'English',
      // 服务商名称
      providerAlibaba: '通义千问',
      providerDeepSeek: 'DeepSeek',
      providerCustom: '自定义',
      // 帮助说明
      howToGetKeyDesc1: '• 通义千问：https://dashscope.console.aliyun.com/apiKey',
      howToGetKeyDesc2: '• DeepSeek: https://platform.deepseek.com/api_keys',
      howToGetKeyDesc3: '• 自定义：填写任意兼容 OpenAI 格式的 API 服务',
    },
    // 日期
    date: {
  ...
  en: {
    ...
    stats: {
      ...
      aiNotConfiguredMsg: 'AI analysis requires API Key configuration. Go to Settings to set it up now?',
      aiConfirmGoSettings: 'Go to Settings',
      aiCancel: 'Cancel',
      aiInvalidKeyTitle: 'Invalid API Key',
      aiInvalidKeyMsgDialog: 'Your API Key appears to be invalid. Go to Settings to update it?',
      aiRequestTimeout: 'Request Timeout',
      aiAnalysisFailed: 'Analysis Failed',
      aiAnalysisFailedDetail: 'Analysis failed: ',
    ...
    settings: {
      ...
      customBgDesc: 'Use custom color as background',
      customBgEnabled: 'Custom background enabled',
      customBgDisabled: 'Custom background disabled',
      ...
      english: 'English',
      // Provider names
      providerAlibaba: 'Tongyi Qianwen',
      providerDeepSeek: 'DeepSeek',
      providerCustom: 'Custom',
      // Help descriptions
      howToGetKeyDesc1: '• Tongyi Qianwen: https://dashscope.console.aliyun.com/apiKey',
      howToGetKeyDesc2: '• DeepSeek: https://platform.deepseek.com/api_keys',
      howToGetKeyDesc3: '• Custom: Any OpenAI-compatible API service',
    },
    // Date
    date: {
